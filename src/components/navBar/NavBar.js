            ...
            <div className="navbar ">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-72 text-black">
                    ...
                    <Link to="/" className="btn btn-ghost normal-case text-xl"><FaLaptopCode className='text-3xl' /> SKILL HUNT</Link>
